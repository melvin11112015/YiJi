...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link top.wefor.now.ui.widget.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link top.wefor.now.ui.widget.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
