package io.github.mlstudio.yiji.tools.permissions;
...
public class PermissionTools {
    ...
    public static PermissionTools with(Activity activity) {
        return new PermissionTools(activity);
    }

    public static PermissionTools with(Fragment fragment) {
        return new PermissionTools(fragment);
    }

    public PermissionTools permissions(String... permissions) {
        this.mPermissions = permissions;
        return this;
    }

    public PermissionTools addRequestCode(int requestCode) {
        this.mRequestCode = requestCode;
        return this;
    }

    public PermissionTools setPermissionsListener(PermissionListener listener) {
     ...
     */
    public PermissionTools request() {
