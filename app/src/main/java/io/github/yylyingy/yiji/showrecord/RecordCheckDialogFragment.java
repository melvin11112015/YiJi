...
public class RecordCheckDialogFragment extends DialogFragment implements RecordCheckDialogRecyclerViewAdapter.OnItemClickListener {
    ...
    private List<YiJiRecord> list;
    private Context mContext;
    private String title;

    @SuppressLint("ValidFragment")
    public RecordCheckDialogFragment(Context context, List<YiJiRecord> list, String title) {
        this.list = list;
        this.title = title;
        mContext = context;
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        title.setTypeface(YiJiUtil.typefaceLatoLight);
        ...
        alert.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface dialog) {
                ...
                btnPositive.setTypeface(YiJiUtil.typefaceLatoLight);
            }
        });
    ...
    public void onItemClick(View view, int position) {
        ...
        dialog = new MaterialDialog.Builder(mContext)
                .icon(YiJiUtil.GetTagIconDrawable(list.get(position).getTag()))
        ...
        date.setText(YiJiUtil.GetCalendarStringRecordCheckDialog(mContext, list.get(position).getCalendar()));
    }
}
